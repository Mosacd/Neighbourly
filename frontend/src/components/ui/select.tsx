...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "data-[placeholder]:text-muted-foreground cursor-pointer [&_svg:not([class*='text-'])]:text-muted-foreground flex w-fit items-center justify-center gap-2 rounded-md border bg-transparent px-3 py-2 whitespace-nowrap transition-[color,box-shadow] duration-300 outline-none disabled:cursor-not-allowed disabled:opacity-50 data-[size=default]:h-9 data-[size=sm]:h-8 *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-2 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
