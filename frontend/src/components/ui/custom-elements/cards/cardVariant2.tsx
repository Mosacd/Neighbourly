...
return(    
<div className="bg-white dark:bg-black max-md:h-[481px] overflow-hidden m-auto border-2 shadow-md py-[21px] 2xl:py-[29px] px-[16px] 2xl:px-[24px] md:max-h-[423px] rounded-[24px] max-w-[375px] md:max-w-[1190px] 2xl:max-w-[1363px] w-full active:cursor-grabbing select-none">
