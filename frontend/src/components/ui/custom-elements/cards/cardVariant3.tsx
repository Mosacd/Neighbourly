     ...
     <Link to={`/Events/${data.id}`} className="bg-white m-auto border-2 shadow-md p-[24px] max-h-[301px] rounded-[24px] max-w-[1113px] w-full">
              <div className="flex justify-between items-center">
                <div className="w-full max-w-[754px] h-[152px]">
                    <h1 className="noto-sans-semibold text-3xl mb-[32px] title-clamp">{data.title}</h1>
                    <p className="noto-sans-regular text-xl text-[#828282] line-clamp-2">{data.Briefdescription}</p>
                </div>
