...
const CardForHome: React.FC<{ data: VolunteerOpportunity }> = ({ data }) => {
  return (
    <div className="bg-[#FFDD71] max-md:h-[481px] border-2 border-main m-auto shadow-md py-[21px] 2xl:py-[29px] px-[16px] 2xl:px-[24px] rounded-[24px] max-w-[375px] md:max-w-[1200px] 2xl:max-w-[1363px] w-full active:cursor-grabbing select-none">
      <div className="flex flex-col-reverse md:flex-row justify-between items-center gap-6 2xl:gap-10">
        <div className="w-full max-w-[852px] flex flex-col items-center text-center md:text-start md:items-start">
          ...
          <p className="noto-sans-regular hidden md:inline sm:text-lg 2xl:text-xl line-clamp-3 text-[#545454] mb-[26px] 2xl:mb-[32px]">
            {data.description}
          </p>
