...
<Select defaultValue="ENG" onValueChange={setSelectedLang}>
  <SelectTrigger className="w-fit lg:w-fit p-0 data-[size=default]:h-[53px] text-xl lg:text-lg 2xl:text-xl border-none noto-sans-regular">
        <svg className="fill-black dark:fill-white stroke-background duration-300 h-[24px] w-[24px] 2xl:h-[32px] 2xl:w-[32px] size-full " viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
