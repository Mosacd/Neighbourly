...
const SearchBar = () => {
    ...
    return(
        <div className="relative group w-full max-w-[830px]">
        <Input placeholder="search..." className="h-[53px] rounded-[8px] border-2 py-[10px] px-[24px] pl-[52px] noto-sans-semibold border-[#696363]"/>
    <svg
        className="absolute left-4 top-1/2 -translate-y-1/2 w-[32px] h-[32px] fill-[#696363] group-focus-within:fill-black pointer-events-none"
        width="32"
        height="33"
        viewBox="0 0 32 33"
