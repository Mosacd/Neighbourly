...
const ToggleSwitch = () => {
  ...
  return (
    <button
      ...
      className={`
        relative hover:cursor-pointer inline-flex h-[48px] w-[88px] max-2xl:lg:h-[40px] max-2xl:lg:w-[72px] items-center rounded-full transition-colors duration-300 ease-in-out focus:outline-none
        ${isOn 
    ...
    >
      <img src={darkModeSVG}
        className={`
          ...
          ${isOn ? 'translate-x-11 max-2xl:lg:translate-x-9' : 'translate-x-1'}
        `}
      />
    </button>
  );
