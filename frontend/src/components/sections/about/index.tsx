...
const About = () => {
    ...
    return(
        <div className="*:flex *:max-lg:text-center *:max-lg:gap-[32px] lg:*:flex-row *:items-center lg:*:justify-between max-w-[1117px] 2xl:max-w-[1396px] m-auto">
            ...
            <img className="w-full max-w-[518px] 2xl:max-w-[658px] dark:rounded-full" src={pic1} alt="" />
            </div>
            <div className="flex-col-reverse">
            <img className="w-full max-w-[518px] 2xl:max-w-[658px] dark:rounded-full" src={pic2} alt="" />
             <div className="max-w-[518px] 2xl:max-w-[688px]">
