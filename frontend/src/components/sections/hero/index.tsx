...
const Hero = () => {
    ...
    return(
        <div className="flex flex-col gap-[32px] lg:flex-row justify-between items-center w-full max-w-[1303px] 2xl:max-w-[1552px] mt-[120px] m-auto">
            ...
            <div className="flex flex-col w-full text-center items-center lg:items-start lg:text-start max-w-[570.05px] 2xl:max-w-[590px]">
                <h1 className="noto-sans-semibold text-xl sm:text-2xl 2xl:text-3xl mb-6 sm:mb-8">Become a Volunteer With <span className="piedra-regular text-main leading-[100%] tracking-[2px] text-[48px] sm:text-[56px] 2xl:text-[64px]">Us</span></h1>
