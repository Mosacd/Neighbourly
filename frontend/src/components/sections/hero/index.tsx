...
const Hero = () => {
    ...
    return(
        <div className="flex flex-col gap-[32px] lg:flex-row justify-center 2xl:gap-[162px] items-center w-full max-w-[1303px] 2xl:max-w-[1552px] mt-[64px] sm:mt-[120px] m-auto">
            <img className="w-full sm:max-w-[570.5px] 2xl:max-w-[695px] dark:rounded-full" src={hero} alt="heroImage" />
